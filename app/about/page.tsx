...
const CRITERIA = [
  {
    description:
      "공개 상태이고 현재 유효한 메뉴 근거가 있는 장소만 표시합니다. 수집만 된 후보나 지점이 불분명한 정보는 공개 지도에 노출하지 않습니다.",
    number: "01",
    title: "무엇을 표시하나요",
  },
  {
    description:
      "정부·지자체 공개 자료와 업장 공식 메뉴를 우선합니다. 운영자 제출 자료나 직접 확인 내용도 다시 열어볼 수 있는 근거로 남깁니다. 프랜차이즈는 지점 단위 판매 여부를 따로 확인합니다.",
    number: "02",
    title: "어떻게 확인하나요",
  },
  {
    ...
    <main className={styles["page"]}>
      <article className={styles["content"]}>
        ...
        <aside className={styles["scope"]}>
          ...
          <p>
            기본 유효기간은 온라인 근거 180일, 직접 확인 90일입니다. 가격, 영업시간, 메뉴 제공
            여부는 바뀔 수 있으므로 방문 전 공식 근거와 업장 안내를 함께 확인해 주세요.
          </p>
        </aside>
