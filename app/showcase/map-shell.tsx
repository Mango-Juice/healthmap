...
function MapDrawing() {
  return (
    <svg
      ...
      viewBox="0 0 900 560"
    >
      <rect className={styles["mapLand"]} height="132" rx="8" width="170" x="82" y="70" />
      <rect className={styles["mapLand"]} height="144" rx="8" width="210" x="610" y="90" />
      <rect className={styles["mapLand"]} height="120" rx="8" width="190" x="420" y="330" />
  ...
  return (
    <>
      <header className={styles["detailHeader"]}>
        <div>
          <span className={styles["detailKicker"]}>균형식 · 도보 5분</span>
      ...
      <div className={styles["detailBody"]}>
        <div className={styles["placeFact"]}>
          <LeafIcon />
...
export function MapShell() {
  ...
  const closeDetail = () => {
    ...
    setDetailOpen(false)
    closeTimerRef.current = window.setTimeout(() => setShowReopen(true), 240)
  }
  const openDetail = () => {
    if (closeTimerRef.current) window.clearTimeout(closeTimerRef.current)
  ...
  return (
    <section aria-labelledby="map-shell-heading" className={styles["mapSection"]}>
      ...
      <div className={styles["mapShell"]} data-testid="map-shell" ref={shellRef}>
        <div className={styles["mapStage"]}>
          <div className={styles["mapCanvas"]} inert={isMobile && detailOpen}>
            <MapDrawing />
            <div className={styles["mapTopbar"]}>
              <strong>건강식 지도</strong>
              <ActionButton aria-label="현재 위치" className={styles["iconButton"]} variant="quiet">
                <LocateIcon />
              </ActionButton>
            </div>
            ...
            <div className={styles["markerOne"]}>
              <MapMarker
                category="vegetables"
                label="그린테이블 강남점"
                onSelect={openDetail}
          ...
          {showReopen && isMobile ? (
            <div className={styles["closedDetail"]} data-testid="detail-closed">
        ...
        {detailOpen && !isMobile ? (
          <aside aria-labelledby="showcase-place-title" className={styles["desktopPane"]}>
            <DetailContent onClose={closeDetail} />
          </aside>
        ) : showReopen ? (
          <div className={styles["desktopClosed"]} data-testid="detail-closed-desktop">
            <ActionButton data-detail-open onClick={openDetail} variant="primary">
              상세 열기
            </ActionButton>
          </div>
