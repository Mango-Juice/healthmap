...
import shared from "./pilot-discovery.module.css"
import styles from "./pilot-search-controls.module.css"
...
export function PilotSearchControls({ query, onQueryChange }: Properties) {
  return (
