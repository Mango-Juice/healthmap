...
import styles from "./food-map-drawer-handle.module.css"
...
export function FoodMapDrawerHandle({
  count,
  loading,
  expanded,
  toggleProps,
  ...
  return (
    <div
      ...
      data-testid="food-map-drawer-handle"
    >
      <button
        {...toggleProps}
        className={styles["toggle"]}
        aria-controls="food-map-panel-content"
      ...
      >
        {selectedName ? (
          ...
          <span className={styles["count"]}>
            <b>{loading ? <FoodMapLoadingStatus label="찾는 중" /> : `${count}곳`}</b>
          </span>
        )}
        <ChevronDownIcon />
      </button>
