...
import type { DiscoveryLocationOutcome } from "./use-food-map-analytics"
...
type DiscoveryLocationOptions = {
  readonly onOutcome?: ((outcome: DiscoveryLocationOutcome) => void) | undefined
}

export function useFoodMapLocation({ onOutcome }: DiscoveryLocationOptions = {}) {
  ...
  const request = useCallback(() => {
    ...
    const unavailable = (outcome: Exclude<DiscoveryLocationOutcome, "resolved">) => {
