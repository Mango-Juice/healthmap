...
import { registerPilotAnalyticsAdversarialTests } from "./pilot-analytics-adversarial"
import { registerPilotCatalogAnalyticsContractTest } from "./pilot-analytics-catalog-contract"
...
test("map selection and an explicit moved-area commit emit only bounded actions", async ({
  ...
  const mapStage = page.getByTestId("pilot-map-stage")
...
registerPilotCatalogAnalyticsContractTest()
registerPilotAnalyticsAdversarialTests()
